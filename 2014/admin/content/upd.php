<?php 
	...
	$record = getRecord("Content",$_REQUEST["id"]);
?>
					...
					<div class="box-widgets" id="elements">
						<div class="box-widgets-cont">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="6">
								...
								<tr>
									<td></td>
									<td><img src="../../uploads/<?php echo $record["background"];?>" width="400" border="0" /><br /></td>
								</tr>
								<?php } ?>
								<tr>
									<td valign="top"><strong>Video:</strong></td>
									<td>
										<input name="video" id="video" type="text" class="fields2" value='<?php echo $record["video"];?>' /><br /><br />
										<?php echo $record["video"];?></td>
								</tr>
								<?php } ?>
								<tr>
									<td>&nbsp;</td>
