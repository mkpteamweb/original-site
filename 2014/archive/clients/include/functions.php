 ...
 *
 *   $Id: functions.php, v1.12 2002/10/13 02:53:50 bugada Exp $
 *
 *
 ***************************************************************************/
...
//
// Ritorna se un tipo di file Ë visualizzabile o meno
//
function is_viewable($filename)
{
	global $include_location, $viewers_folder_name, $phpExt;
...
// determinto file Ë stato scaricato
//
...
function get_mimetype_img($filename)
{
	...
	// Se Ë una directory prendo l'icona adeguata
...
//
// Ritorna la dimensione del file con relativa unitý di misura
//
...
//
// Dato un file ritorna se Ë un file nascosto (da non mostrare) o meno
...
{
  global $charsetencoding,$skins,$skinindex,$headerpage,$include_location;
  ...
  if (file_exists($headerpage))
    include($include_location.$headerpage);        // Include user portion of page
}
...
function place_message($title, $message, $link)
{
	...
	// Controllo se l'utente Ë loggato o meno
	...
	<div align=\"center\">
	  <table border=\"0\" width=\"90%\" bgcolor=\"$bordercolor\" cellpadding=\"4\" cellspacing=\"1\">
	    <tr>
	      <td align=\"left\" bgcolor=\"$headercolor\">
	        <table border=\"0\" width=\"100%\">
	          <tr>
	            <th align=\"left\" bgcolor=\"$headercolor\" valign=\"middle\" width=\"50%\">$uploadcentercaption</th>
	            <td align=\"right\" bgcolor=\"$headercolor\" valign=\"middle\" width=\"50%\" nowrap>
	              <p><font face=\"$font\" size=\"1\" color=\"$headerfontcolor\">$title</font></p>
	            </td>
	          </tr>
	        </table>
	      </td>
	    ...
	    <tr>
	      <td align=\"left\" bgcolor=\"$tablecolor\" valign=\"middle\">
	        <table border=\"0\" width=\"100%\">
	          <tr>
	            <th align=\"left\" valign=\"middle\" width=\"75%\">
	...
	echo "      	</font>
	            ...
	            <td align=\"right\" valign=\"middle\" width=\"20%\">
	              <a href=\"$homeurl\"><img src=\"images/home.gif\"  align=\"ABSMIDDLE\" alt=\"$mess[25]\" title=\"$mess[25]\" border=\"0\" /></a>&nbsp;
	              <a href=\"$link?".SID."\"><img src=\"images/refresh.gif\"  align=\"ABSMIDDLE\" alt=\"$mess[97]\" title=\"$mess[97]\" border=\"0\" /></a>&nbsp;";
	if ($user_status == ADMIN)
	{
		echo "    <a href=\"configure.".$phpExt."?".SID."\"><img src=\"images/config.gif\"  align=\"ABSMIDDLE\" alt=\"$mess[132]\" title=\"$mess[132]\" border=\"0\" /></a>&nbsp;
				  <a href=\"usrmanag.".$phpExt."?".SID."\"><img src=\"images/users.gif\"  align=\"ABSMIDDLE\" alt=\"$mess[137]\" title=\"$mess[137]\" border=\"0\" /></a>&nbsp;";
	}
	if ($user_status != ANONYMOUS)
	{
		echo "    <a href=\"login.".$phpExt."?".SID."\"><img src=\"images/user.gif\"  align=\"ABSMIDDLE\" alt=\"$mess[81]\" title=\"$mess[81]\" border=\"0\" /></a>&nbsp;";
	}
	echo "       </td>
...
function create_user_profile($username)
{
  global $users_folder_name, $enc_user_pass, $enc_logged_user_id, $user_email;
  global $user_status, $activationcode, $user_temp_info, $user_wish_receive_digest;
  global $user_account_creation_time, $language, $uploads_folder_name;
  ...
  fwrite($fp, "\n");
  fclose($fp);
  mkdir("$uploads_folder_name/$username", 0755);
  copy('include/index.html', "$uploads_folder_name/$username/index.html");
}
...
{
	global $footerpage, $include_location;

#	echo "	<center>
#				<br>
#				<a href=\"http://phpatm.kc-it.com\" target=\"_blank\"><font size=1 face=\"Verdana\" color=\"#888888\">Powered by PHP-ATM v".PROGRAM_VERSION."</font></a> - 
#				<a href=\"http://dyna-fx.com\" target=\"_blank\"><font size=1 face=\"Verdana\" color=\"#888888\">Mod by Dyna-Fx v1.20r1.0</font></a>
#			    <br>
#			</center>
#		";
	...
	echo "	<center>
				<br>
				<font size=1 face=\"Verdana\" color=\"#888888\">Powered by PHP-ATM v".PROGRAM_VERSION."</font> - 
				<font size=1 face=\"Verdana\" color=\"#888888\">Mod by Dyna-Fx v1.20r1.0</font>
			    <br>
			</center>
		";
	include($include_location.$footerpage);
	echo "\n</body>\n";
	echo "</html>";
}
