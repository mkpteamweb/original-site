 ...
 *
 *   $Id: conf.php, v1.12 2002/10/13 11:53:50 bugada Exp $
 *
 *
 ***************************************************************************/
...
//
$homeurl = "http://".$_SERVER["SERVER_NAME"]."/clients/";

//
// The name of administrator (usually your name)
//
$admin_name = 'MKP Communications';

//
// Administrator e-mail address
//
$admin_email = 'info@mkpteam.com';
...
//
$users_folder_name = 'lunaroja/luna_users';
$userstat_folder_name = 'lunaroja/luna_userstat';
$uploads_folder_name = 'lunaroja/lejeanpocket';
$languages_folder_name = 'lunaroja/luna_languages';
$stats_folder_name = 'lunaroja/luna_stats';
$viewers_folder_name = 'lunaroja/luna_viewers';
...
//
//  STATUS    => array(view,    modown,  delown,  download, mail,    upload,  mkdir,   modall,  delall,  mailall,  webcopy,  validate,  move,   viewown)
//                       V        V        V        V         V        V        V        V        V        V         V         V          V         V
$grants = array(
	ANONYMOUS => array(false,    FALSE,   FALSE,   false,     FALSE,   false,   false,   FALSE,   FALSE,   FALSE,    false,    false,  false,   false),
	UPLOADER  => array(false,    false,   false,   false,    false,   true,    false,   false,   false,   false,    false,     false,  false,   true),
	VIEWER    => array(false,    false,   false,   false,    false,   false,   false,   false,   false,   false,    false,    false,  false,   true),
	NORMAL    => array(false,    false,    false,    true,     true,    false,    false,    false,   false,   false,    false,    false,  false,   true),
	POWER     => array(false,    true,    true,    true,     true,    true,    false,    false,   false,   false,     false,     false,   false,   true),
	ADMIN     => array(TRUE,    TRUE,    TRUE,    TRUE,     TRUE,    TRUE,    TRUE,    TRUE,    TRUE ,   TRUE,     TRUE,     TRUE,   TRUE,    FALSE)
);
...
//
$page_title = 'Client Access Area - MKP Communications :: mkpteam.com';
...
//
// How many upload boxes do you want to show:
//
$num_of_upload_boxes = 5;
...
//
$rejectedfiles = "^index\.|\.desc$|\.dlcnt$|\.php$|\.php3$|\.cgi$|\.pl$|\.asp$|\.aspx$|\.php$|\.php3$|\.htm$|\.js$|\.jsp$|\.py$";
...
$skins = array(
  array(
    'bordercolor' => '#515256',    // The table border color
    'headercolor' => '#68A32B',    // The table header color
    ...
    'bodytag' => "topmargin=\"0\" leftmargin=\"0\" bgcolor=\"#FFFFFF\" text=\"#000000\" link=\"#000000\" vlink=\"#333333\" alink=\"#000000\""
  )
);
...
'.tiff' => array('img' => 'jpg.gif', 'mime' => 'image/tiff'),
'.tif'  => array('img' => 'jpg.gif', 'mime' => 'image/tiff'),
