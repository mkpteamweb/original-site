 ...
 *
 *   $Id: viewer_top.php, v1.20 2003/03/09 19:53:50 bugada Exp $
 *
 *
 ***************************************************************************/
...
echo "<a href=\"javascript:window.print()\"><img src=\"images/imprimer.gif\" alt=\"$mess[27]\" title=\"$mess[27]\" border=\"0\" align=\"ABSMIDDLE\"></a>\n";
echo "<a href=\"index.${phpExt}?action=downloadfile&filename=".$filename."&directory=".$directory."&".SID."\"><img src=\"images/download.gif\" alt=\"$mess[23]\" title=\"$mess[23]\" width=\"20\" height=\"20\" border=\"0\" align=\"ABSMIDDLE\"></a>";
echo "</center>\n";
echo "</body>\n";
echo "</html>";