...
"85" => "VÊlg tidszone",
"86" => "Din aktuelle tid",
"88" => "VÊr venlig at indtaste en gyldig E-mail.",
"89" => "Din E-mail skal vÊre gyldig og aktiv da din personlige aktiverings kode vil blive sendt til din E-mail.",
"90" => "Fil uploaded: ",
"91" => "VÊr venlig at indtaste den E-mail adresse du indtastede under registrationen.",
"92" => "Fil st¯rrelse: ",
"93" => "Husk at skrive dit brugernavn og kodeord ned.",
"94" => "Det er n¯dvendig at Registrerer dig.",
"95" => "Det er ikke n¯dvendig at Registrerer dig. Du kan registrere dig hvis du vil og hvorved du kan uploade filer og modtage E-mails om nye filer pÂ siden.",
"96" => "Udseende valgt.",
"97" => "Opdater",
"98" => "Indtast venligst dit brugernavn og kodeord",
"99" => "Endnu ikke registreret? - Registrer her!",
"100" => "Har du glemt dit kodeord?",
"101" => "VÊr venlig, at gÂ %s tilbage %s og pr¯v igen.",
"102" => "Du er blevet logget ud fra siden.",
"103" => "Dit brugernavn er ugyldigt. Brugernavnet mÂ ikke overskride 12 karakterer og mÂ kun indeholde bogstaver og tal. Derudover mÂ det ogsÂ indeholde '-', '_', og mellemrum dog ikke som fÊrste eller sidste tegn.",
...
"108" => "Tak for din registrering. Husk dit kodeord da det er blevet krypteret og vi kan derfor ikke sende det til dig. Hvis du glemmer dit kodeord tilbyder vi et easy to use script hvorved en ny tilfÊldig kode kan sendes til dig.",
"109" => "GÂ til %s Upload Center her. %s",
...
"112" => "Aktiver konto",
"113" => "VÊr venlig at aktivere din konto",
"114" => "aktiveringskode",
"115" => "Din konto er nu aktiv.",
"116" => "Venligst %s gÂ ind her %s.",
"117" => "Brugernavn eller aktiveringskode er ugyldig.",
"118" => "Kontoen er allerede aktiv.",
"119" => "Jeg ¯nsker at modtage til min e-mailen daglig opdatering af nye filer pÂ siden.",
...
"140" => "Din konto '%s' blev Êndret",
"141" => "Senest",
"142" => "Alle",
"143" => "Den nye e-mail trÊder i kraft efter bekrÊftelse. En bekrÊftelses kode er sendt til den nye mail adresse. Se instruktionerne i mailen.",
"144" => "",
"145" => "Venligst, bekrÊt din nye e-mail adresse.",
"146" => "BekrÊftelses kode",
"147" => "BekrÊft",
"148" => "Intet at bekrÊfte.",
"149" => "Det indtastede brugernavn eller bekrÊftelses kode er ugyldig.",
"150" => "Din nye e-mail adresse '%s' er bekrÊftet.",
"151" => "Oploadede filer",
...
"175" => "Inaktiv",
"176" => "ikke godkendt",
"177" => "Serveren kunne desvÊre ikke eksekverer mail programmet.",
...
"188" => "opret bib",
"189" => "biblioteket eksiterer allerede, vÊlg venligst et andet navn",
"190" => "Du skal angive et biblioteks navn",
"191" => "ndre",
"192" => "Filnavn",
"193" => "Êndre fil / biblioteks detaljer",
"194" => "objektet blev omd¯bt.",
"195" => "du har ikke tilladelse til at omd¯be dette objekt",
"196" => "Rod stien er ikke correct. Check opsÊtningen",
"197" => "sorter efter",
...
"208" => "Din IP adresse er spÊrret af administrationen!",
...
//
$sendfile_email_subject = 'ÿnsket fil';
$sendfile_email_body = '
Her er den fil du bedte om at fÂ tilsendt pÂ mail
...
//
$confirm_email_subject = 'BekrÊft ny e-mail';
$confirm_email_body = 'KÊre %s,

Da din sikkerhed er vigtig for os, er det n¯dvendigt at fÂ bekrÊftet din nye e-mail adresse.

Din personlige bekrÊftelses kode er: %s

Aktivering af din e-mail adresse er simpel:
1. Bes¯g os pÂ %s og vi vil guide dig igennem processen.
2. Indtast dit brugernavn og bekrÊftelses kode.
3. Tryk pÂ \'Confirm\' knappen.
...
//
$register_email_subject = 'BekrÊft registration';
$register_email_body = 'KÊre %s,
